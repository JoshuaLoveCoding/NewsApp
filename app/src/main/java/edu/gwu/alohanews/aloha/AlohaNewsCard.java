...
@Layout(R.layout.aloha_news_card)
public class AlohaNewsCard {
    ...
    public AlohaNewsCard(News news, SwipePlaceHolderView swipeView, OnSwipeListener onSwipeListener) {
        this.news = news;
